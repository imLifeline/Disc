module.exports = {
    ...
    async execute(client, message) {
        ...
        if (timestamp.progress == 'Infinity')
            return message.reply({ content: `${client.config.deny} | This song is live streaming, no duration data to display.`, allowedMentions: { repliedUser: false } });
    ...
    async slashExecute(client, interaction) {
        ...
        if (timestamp.progress == 'Infinity')
            return interaction.reply({ content: `${client.config.deny} | This song is live streaming, no duration data to display.`, allowedMentions: { repliedUser: false } });
